...
gathered in steps 5–7. That is what makes [the golden snapshot](../04-engine/golden-test.md)
possible.
...
"import failed" is not. See [CSV import](../06-data/csv-import.md).

---

Related: [Rule engine](../04-engine/rule-engine.md) · [CSV import](../06-data/csv-import.md) · [System architecture](system-architecture.md)
