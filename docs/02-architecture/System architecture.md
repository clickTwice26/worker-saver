...
**The engine is pure on purpose.** It is what makes the [[Golden test]]
...
no static root to keep in step with a deploy. See [[Deployment]].

---

Related: [[Data model]] · [[Request lifecycle]] · [[Technology choices]]
