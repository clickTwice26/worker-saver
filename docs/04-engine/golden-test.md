...
- **Every commitment completes on or before its machine** — the regression test
  for the lead-time bug in [Scheduling arithmetic](scheduling-arithmetic.md)

---

Related: [Rule engine](rule-engine.md) · [Scheduling arithmetic](scheduling-arithmetic.md)
