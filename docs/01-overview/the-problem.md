...
sources before quoting these externally** — see [Decision log](../10-reference/decision-log.md).
...
```mermaid
flowchart TD
    A["Factory commits to a machine"] --> B["Machine arrives"]
    B --> C["Management decides who stays"]
    C --> D["Separations"]

    A -.->|"the window nobody uses"| W["6-24 months<br/>enough time to retrain"]
    W -.-> C
...
Related: [What is ALE Insight](what-is-ale-insight.md) · [Who it is for](who-it-is-for.md) · [Risk knowledge base](../03-domain/risk-knowledge-base.md)
