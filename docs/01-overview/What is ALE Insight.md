...
vendor could honestly have pre-trained on. See [[ML overview]].

**It ships with no customer data.** A fresh install has reference data — the
role taxonomy, the [[Machine catalogue]], the [[Risk knowledge base]] — and no
...
[[Rule engine]] and [[The baseline gate]].
...
Next: [[The problem]] · [[Who it is for]] · [[System architecture]]
