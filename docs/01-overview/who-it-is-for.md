...
Lands on [Plan](../07-interface/pages-and-navigation.md). Capacity is the binding constraint in
every schedule, which is why [training seat capacity](../03-domain/training-and-wages.md) is
...
[Machine catalogue](../03-domain/machine-catalogue.md).
...
Related: [Pages and navigation](../07-interface/pages-and-navigation.md) · [Machine catalogue](../03-domain/machine-catalogue.md) · [Recording outcomes](../06-data/recording-outcomes.md)
