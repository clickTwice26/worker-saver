...
its lower bound is what [The baseline gate](the-baseline-gate.md) tests.
...
Related: [Training pipeline](training-pipeline.md) · [The baseline gate](the-baseline-gate.md) · [Features](features.md)
