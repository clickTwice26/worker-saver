...
| **Baseline** | The rule engine's score, measured on the same held-out folds as the model. See [The baseline gate](../05-machine-learning/the-baseline-gate.md). |
...
| **Golden file** | A committed snapshot of full engine output. See [Golden test](../04-engine/golden-test.md). |
